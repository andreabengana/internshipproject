...
<head>
	...
	<!--Custom CSS-->
	<link rel="stylesheet" type="text/css" href="css/addmanagerdesign.css">
</head>
<body>
<div class="container">
	<div class="d-flex justify-content-center h-100">
		<div class="card">
			<div class="card-header text-center">
				<a href="homepage.php" class="btn btn-danger float-left">Go Back</a><h2 style="color: white;">Add Manager</h2>
			</div>
			<div class="card-body">
						<form id="form1" action="includes/addmanager.inc.php" method="POST">
							<label for="row1"><h3> Tell me more about yourself! </h3></label>
  							...
  							<select class="form-control" name="position" value="Manager">
                <option>Manager</option>
                </select> 								
                <br>
 								<button type="submit" class="btn btn-lg btn-success btn-block" name="signup-btn">Add Manager</button>
						</form>
			</div>
		</div>
	</div>
